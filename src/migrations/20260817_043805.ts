...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_shipping_address_state" AS ENUM('NSW', 'VIC', 'QLD', 'SA', 'WA', 'TAS', 'NT', 'ACT');
  ...
  CREATE TYPE "public"."enum_orders_shipping_address_state" AS ENUM('NSW', 'VIC', 'QLD', 'SA', 'WA', 'TAS', 'NT', 'ACT');
  CREATE TYPE "public"."enum_footer_social_links_platform" AS ENUM('Instagram', 'Facebook', 'Twitter', 'TikTok', 'YouTube');
  ...
  CREATE TABLE "users" (
  	...
  	"shipping_address_state" "enum_users_shipping_address_state",
  ...
  CREATE TABLE "orders" (
  	...
  	"shipping_address_state" "enum_orders_shipping_address_state",
  	"shipping_address_postcode" varchar NOT NULL,
  	"notes" varchar,
  ...
  CREATE TABLE "header" (
  	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
  	"brand_name" varchar DEFAULT 'Z-VAPE',
  ...
  CREATE TABLE "footer" (
  	...
  	"customer_service_hours" varchar,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  ALTER TABLE "brands" ADD CONSTRAINT "brands_banner_image_id_media_id_fk" FOREIGN KEY ("banner_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "brands_banner_image_idx" ON "brands" USING btree ("banner_image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_users_shipping_address_state";
